...
@Component
public class CheckFindUsernameValidator extends AbstractValidator<FindUsernameRequestDto> {

    private final RedisUtil redisUtil;

    @Override
    protected void doValidate(FindUsernameRequestDto dto, Errors errors) {
